...
class Controller_Customers extends Controller_Base
{
	...
	public function action_all(){
		if(!Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('ib_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('franchisescheme_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('whitelabel_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('seniorpartner_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('callback_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('inquiry_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('small_registration_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('forexblog_ib_registration_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('promotions_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('videoconference_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('demoaccount_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('fb_home_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('pay_order_info_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
	...
	{
		if(!Sentry::user()->has_access('cmginfo_read') && !Sentry::user()->has_access('all_tables_read')) self::no_access();
